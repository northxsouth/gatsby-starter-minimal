...
type SitePluginPluginOptions = {
  ...
  readonly postCssPlugins: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
...
type SitePluginPluginOptionsFilterInput = {
  ...
  readonly postCssPlugins: Maybe<StringQueryOperatorInput>;
...
type SitePageFieldsEnum =
  ...
  | 'pluginCreator.pluginOptions.fonts.family'
  | 'pluginCreator.pluginOptions.fonts.variable'
  | 'pluginCreator.pluginOptions.fonts.weights'
...
type SitePluginFieldsEnum =
  ...
  | 'pluginOptions.query'
  | 'pluginOptions.fonts'
  | 'pluginOptions.fonts.family'
  | 'pluginOptions.fonts.variable'
  | 'pluginOptions.fonts.weights'
